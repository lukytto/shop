...
class User {
public:
	void ListItemAll(); // List all items
	void ListItemByC(); // List items by category
	void ListItemByN(); // List items by name
	void ItemInfor(); // See more information of one item
	void PrintUserArray(); // Output user information to User.txt
	void PrintItemArray(); // Output item information to Item.txt
