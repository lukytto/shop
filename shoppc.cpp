// shoppc.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void Welcome() { // Welcome interface
	...
	while (status == 0) {
		...
		if (account == "blue" && pwd.GetPassword() == "bad") return;
